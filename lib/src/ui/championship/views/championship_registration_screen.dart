  ...
  Widget build(BuildContext context) {
    if (viewModel != null) {
      return ChangeNotifierProvider.value(
        value: viewModel!,
        child: _ChampionshipRegistrationView(championshipToEdit: championshipToEdit),
      );
    } else {
      return _ChampionshipRegistrationView(championshipToEdit: championshipToEdit);
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return Consumer<ChampionshipRegistrationViewModel>(
      builder: (context, viewModel, child) {
        ...
        if (viewModel.state == ChampionshipRegistrationState.success) {
           WidgetsBinding.instance.addPostFrameCallback((_) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(isEditing ? 'Campeonato atualizado!' : 'Campeonato registrado!')),
            );
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text(isEditing ? 'Editar Campeonato' : 'Cadastro de Campeonato'),
            centerTitle: true,
          ),
          body: Padding(
